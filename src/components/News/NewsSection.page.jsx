...
export default function NewsSection() {
  ...
  const NewsData = [
    ...
    {
        title: "For Honor’s First Egyptian Hero, the Medjay, Arrives July 28",
        date: "July 21, 2022",
        image: "./assets/FH_Medjay_Hero.jpg",
    },
    {
        title: "How One Assassin's Creed Valhalla Developer Created The Isu Language From Scratch",
        date: "July 19, 2022",
        image: "./assets/ACV_Mythical_Asgard-2576255f84eb98ac48a7.38479286.jpg",

    },
    {
        title: "How Ubisoft and NOMAD Group “Modded” Watch Dogs: Legion",
        date: "July 17, 2022",
        image: "./assets/UbisoftNews_ModdingArticle.png",
    },
    {
        title: "This Week at Ubisoft: The Division Resurgence Gameplay Revealed, Assassin’s Creed Games Coming to Ubisoft+ Classics",
        date: "July 15, 2022",
    ...
    {
      title:
        "This Week at Ubisoft: Skull and Bones Coming November 8, The Division Resurgence Announced",
      date: "July 8, 2022",
    ...
    {
      title:
        "This Week at Ubisoft: Mario + Rabbids Sparks of Hope Coming This Fall, Rabbids: Party of Legends Out Now",
      date: "July 1, 2022",
    ...
    {
      title:
        "The Crew 2 Celebrates Its 4th Anniversary, Season 6 Episode 1 Coming July 6",
      date: "June 30, 2022",
    ...
    {
      title:
        "This week at Ubisoft: New Roller Champions Season, Hot Summer Sales Live Now",
      date: "june 24, 2022",
    ...
    {
      title:
        "watch dogs : Legion - new story about details and post-launch plans revealed",
      date: "october 6, 2020",
      image: "./assets/news-image-sample-5.jpg",
    },
    {
      title:
        "This Week at Ubisoft: Assassin’s Creed Kicks Off 15th Anniversary Celebration, Rainbow Six Siege Vector Glare Out Now",
      date: "June 17, 2022",
        ...
        <div className="container-lg">
          <div class="row">
            <div className="col-md-6 col-sm-12">
              <div class="row">
                <NewsCardFeatured news={NewsData[0]} />
                <NewsCard align={!inverted} news={NewsData[3]} />
              </div>
            </div>
            {/* Same order at ubinews */}
            <div className="col-md-6 col-sm-12 p-0">
              <NewsCard align={!inverted} news={NewsData[1]} />
              <NewsCard align={!inverted} news={NewsData[2]} />
              <NewsCard align={!inverted} news={NewsData[4]} />
            </div>
          </div>
        </div>
      )}
          ...
          <div class="row">
            {NewsData.filter((news) => {
              return news.title
                .toUpperCase()
                .split(" ")
                .some((val) => filterData.indexOf(val) >= 0);
            }).map((data, i) => {
              return (
                <div className="col-md-6 col-sm-12 p-0">
                  <NewsCard align={trueAlign} news={data} />
                </div>
              );
            })}
          </div>
